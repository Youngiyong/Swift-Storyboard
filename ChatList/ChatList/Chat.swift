...
extension Chat {
    static let list: [Chat] = [
        ...
        Chat(name: "jenny", chat: "🌸 내일 꽃이 피나봐요, 한강으 로 꽃보면서, 치맥이나 가자", date: "2022-03-01"),
        
        Chat(name: "sera", chat: "🏃‍♀️ 지금 당장 나가서 탄천 두 바 퀴 뛰고와라.. ", date: "2022-03-02"),
        Chat(name: "mini", chat: "🆕 새로운 신간 환타지 소설 작 성했습니다. ", date: "2022-03-02"),
